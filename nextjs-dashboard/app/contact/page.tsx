...
// ===============================
// 役割：
// ・名前、メールアドレス、メッセージを入力するフォームを表示する
// ・入力された内容で新しい Thread を作成する API (POST /api/threads) を呼び出す
// ・API 成功後、EmailJS を使ってユーザーにチャットページの URL を記載したメールを送信する
// ・送信完了後は、完了メッセージとチャットページへのリンクを表示する
// ===============================
